        ...
        <>
            ...
            <Form method="post" onSubmit={register}>
                <Form.Group className="mb-3" controlId="exampleForm.ControlInput1">
                    ...
                    <Form.Control type="text" placeholder="Tên..." value={user["ten"]} onChange={e => change(e, "ten")} />
                </Form.Group>
                <Form.Group className="mb-3" controlId="exampleForm.ControlInput1">
                    <Form.Label>Họ và tên lót</Form.Label>
                    <Form.Control type="text" placeholder="Họ và tên lót..." value={user["ho"]} onChange={e => change(e, "ho")} />
                </Form.Group>
                ...
                <Form.Group className="mb-3" controlId="exampleForm.ControlInput2">
                    ...
                    <Form.Text className="text-muted">
                        CCCD must be exactly 10 digits.
                    </Form.Text>
                </Form.Group>
                <Form.Group className="mb-3" controlId="exampleForm.ControlInput2">
